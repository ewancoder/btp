...
.. _development: https://github.com/ewancoder/btp/tree/dev
.. _zip: https://github.com/ewancoder/btp/archive/master.zip
...
Now, you can browse my `github`_ repo and download game as archive. Soon I'll finally make release v0.1, which will contain browse-walking system ready-made (yet without quests, battles, etc). Right after than I'll add `development`_ **dev** branch and all newest changes will go there, when **master** branch will contain all most **stable** versions like 0.1.1 or 0.1.2, and **releases** will contain most stable and biggest versions like 0.2, 0.3 and 1.0 (someday).

To download lastest (stable) version from git, either click `zip`_ link, or run::
