class Data():
    def update(self, pers):
        ...
        self.place.append({
            ...
            'Text': 'This is the place where you\'ve been raised. Old man are now gone for a ' + str(20 + (pers.time / (24 * 60))) + ' days. So you are decided to go off [CHANGEABLE BY TIME AND OTHER FACTORS].\nYou can go [out] or [upstairs]. Also you can check [chest] under the window.',
