...
class IntroText():
    ...
    def __init__(self, name):
        self.introtext2 = [
            'After all world has merged, all the Elvines has died, for they did not belong to a new world created by curious Elder One, they did not managed to bear their cause, to save world each from another apart. All, but for Lucifer who was exalted and was not anymore one of the Elvines.',
            ...
            'And so it was for twenty long years, blood spilled on earth until the Earth could not absorb it anymore, and then blood became rivers. They formed 3 big forks, and they was named upon 3 greatest warrior on that war: Lieones, Batrexar and Adela',
